...
| `asset-list.md` | Full art/VFX/icon/background production list; every count decided except enemies and world backgrounds | Art production planning. The two open rows are blocked on #6. Volume totals corrected and the Artifact icon basis settled at 48, 2026-09-17 |
