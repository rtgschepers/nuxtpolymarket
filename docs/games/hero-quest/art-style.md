...
**The round count has restarted three times** (2026-09-25/26): once the chibi style was adopted, again once the Hero designs were locked, and again once World 1 was locked. `ART_ROUNDS` is empty, so the gallery opens on the first group. **The next round is Round 1.** The tables below are the history; none of those round numbers are in the gallery any more.
...
- **World 1 is done and locked** (see §1). **Everything else is still round-1 art:** the enemies and bosses of Worlds 2–10, the other 58 VFX, and the other 9 worlds. On the stage the old enemies look undersized next to the chibi Heroes and Champions.
